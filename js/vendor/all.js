/*1371325559,179359579,JIT Construction: v847175,en_US*/
...
try {
	window.FB || (function (window) {
		...
		__d("XDConfig", [], {"XdUrl": "connect\/xd_arbiter.php?version=25", "Flash": {"path": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/yY\/r\/tkKkN2MZL-q.swf"}, "useCdn": true});
		...
		__d("sdk.Runtime", ["sdk.Model", "copyProperties", "sdk.RuntimeConfig"], function (a, b, c, d, e, f) {
			var g = b('sdk.Model'), h = c('sdk.RuntimeConfig'), i = b('copyProperties'), j = {UNKNOWN: 0, PAGETAB: 1, CANVAS: 2, PLATFORM: 4}, k = new g({AccessToken: '', ClientID: '', Environment: j.UNKNOWN, Initialized: false, KidDirectedSite: undefined, Locale: h.locale, LoginStatus: undefined, Rtl: h.rtl, Scope: undefined, Secure: undefined, UseCookie: false, UserID: '', CookieUserID: ''});
		...
		__d("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.Event", "guid", "Log", "QueryString", "Queue", "resolveURI", "resolveWindow", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "wrapFunction", "XDM", "XDConfig"], function (a, b, c, d, e, f) {
			...
			function na(pa, qa) {
				...
				var sa = g.appendHidden(document.createElement('div')), ta = v.create({root: sa, channel: ca, channelPath: '/' + u.XdUrl + '#', flashUrl: u.Flash.path, whenReady: function (ua) {
					...
					if (q.getSecure() !== true)z = h({url: xa + wa, name: 'fb_xdm_frame_http', id: 'fb_xdm_frame_http', root: sa, 'aria-hidden': true, title: ga, 'tab-index': -1});
		...
		__d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, b, c, d, e, f) {
			...
			function z(fa, ga) {
				...
				r.setUserID(ia);
				w = fa;
				var qa = {authResponse: fa, status: ga};
			...
			function ba(fa, ga, ha) {
				return function (ia) {
					...
					if (ia && ia.access_token) {
						...
						ga = {accessToken: ia.access_token, userID: ka.user_id, expiresIn: parseInt(ia.expires_in, 10), signedRequest: ia.signed_request};
						if (r.getUseCookie()) {
					...
					if (fa)fa({authResponse: ga, status: r.getLoginStatus()});
					return ga;
				};
			}
			...
			function ca(fa) {
				...
				var ia = ba(fa, w, 'login_status'), ja = u(t.resolve('www', true) + '/connect/ping').setSearch(q.encode({client_id: r.getClientID(), response_type: 'token,signed_request,code', domain: location.hostname, origin: l(), redirect_uri: v.handler(function (ka) {
					if (k('e2e_ping_tracking', true)) {
						var la = {init: ha, close: ES5('Date', 'now', false), method: 'ping'};
						o.debug('e2e: %s', ES5('JSON', 'stringify', false, la));
						n.log(114, {payload: la});
					}
				...
				}, 'parent'), sdk: 'joey', kid_directed_site: r.getKidDirectedSite()}));
				ga = i({root: j.getRoot(), name: m(), url: ja.toString(), style: {display: 'none'}});
			}
			...
			function ea(fa, ga) {
				...
				if (fa)if (!ga && da == 'loaded') {
					fa({status: r.getLoginStatus(), authResponse: aa()});
					return;
			...
			h(y, {getLoginStatus: ea, fetchLoginStatus: ca, setAuthResponse: z, getAuthResponse: aa, parseSignedRequest: s.parse, xdResponseWrapper: ba});
			e.exports = y;
		});
		...
		__d("ApiClient", ["ArgumentError", "Assert", "copyProperties", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "UrlMap", "URL", "ApiClientConfig"], function (a, b, c, d, e, f) {
			var g = b('ArgumentError'), h = b('Assert'), i = b('copyProperties'), j = b('CORSRequest'), k = b('FlashRequest'), l = b('flattenObject'), m = b('JSONPRequest'), n = b('Log'), o = b('ObservableMixin'), p = b('sprintf'), q = b('UrlMap'), r = b('URL'), s = b('ApiClientConfig'), t, u, v, w = {get: true, post: true, 'delete': true, put: true}, x = {fql_query: true, fql_multiquery: true, friends_get: true, notifications_get: true, stream_get: true, users_getinfo: true};
			...
			function y(da, ea, fa, ga) {
				...
				if (v)i(fa, v);
				fa = l(fa);
				var ha = {jsonp: m, cors: j, flash: k}, ia;
				if (fa.transport) {
					ia = [fa.transport];
					delete fa.transport;
		...
		__d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "copyProperties", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function (a, b, c, d, e, f) {
			var g = b('sdk.Auth'), h = b('sdk.Content'), i = b('copyProperties'), j = b('sdk.Dialog'), k = b('sdk.DOM'), l = b('sdk.Event'), m = b('flattenObject'), n = b('sdk.Frictionless'), o = b('sdk.getContextType'), p = b('guid'), q = b('insertIframe'), r = b('Log'), s = b('sdk.Native'), t = b('QueryString'), u = b('resolveURI'), v = b('sdk.RPC'), w = b('sdk.Runtime'), x = c('SDKConfig'), y = b('UrlMap'), z = b('UserAgent'), aa = b('sdk.XD'), ba = {transform: function (ea) {
				...
				} else i(ea.params, {client_id: w.getClientID(), redirect_uri: u(da.xdHandler(fa, ga, 'opener', g.getAuthResponse(), 'permissions.oauth')), origin: o(), response_type: 'token,signed_request', domain: location.hostname});
				return ea;
				...
				if (ea.params.display == 'dialog' || ea.params.display == 'iframe')i(ea.params, {display: 'iframe', channel: da._xdChannelHandler(ea.id, 'parent.parent')}, true);
				return ea;
				...
				if (na === 'parent')i(ka.params, {channel_url: da._xdChannelHandler(ia, 'parent.parent')}, true);
		...
		__d("sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function (a, b, c, d, e, f) {
			...
			var x = {_setHidePluginCallback: function (y) {
				n = y;
			}, hidePluginElement: v, showPluginElement: w};
			e.exports = x;
		});
		...
		__d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "copyProperties", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function (a, b, c, d, e, f) {
			var g = b('sdk.Arbiter'), h = b('sdk.Auth'), i = b('sdk.Content'), j = b('copyProperties'), k = b('sdk.DOM'), l = b('sdk.Event'), m = b('sdk.XFBML.Element'), n = b('guid'), o = b('insertIframe'), p = b('QueryString'), q = b('sdk.Runtime'), r = b('sdk.ui'), s = b('UrlMap'), t = b('sdk.XD'), u = m.extend({_iframeName: null, _showLoader: true, _refreshOnAuthChange: false, _allowReProcess: false, _fetchPreCachedLoader: false, _visibleAfter: 'load', _widgetPipeEnabled: false, _borderReset: false, _repositioned: false, getUrlBits: function () {
				...
				return j({api_key: q.getClientID(), locale: q.getLocale(), sdk: 'joey', kid_directed_site: q.getKidDirectedSite(), ref: this.getAttribute('ref')}, this.getUrlBits().params);
			}, _getURL: function () {
		...
		__d("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.ConnectBar", "sdk.XFBML.Like", "sdk.XFBML.LiveStream", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration", "sdk.XFBML.SocialContext"], function (a, b, c, d) {
			...
			ES5(ES5('Object', 'keys', false, j), 'forEach', true, function (o) {
				l.registerTag({xmlns: 'fb', localName: o.replace(/_/g, '-'), ctor: i.withParams(j[o])});
			});
			ES5(ES5('Object', 'keys', false, m), 'forEach', true, function (o) {
				l.registerTag({xmlns: 'fb', localName: o.replace(/_/g, '-'), ctor: m[o]});
			});
			h.provide('XFBML', {parse: function (o) {
				e.maybeXfbml(o, 'Invalid argument');
				if (o && o.nodeType === 9)o = o.body;
				return l.parse.apply(null, arguments);
			}});
			h.provide('XFBML.RecommendationsBar', {markRead: function (o) {
