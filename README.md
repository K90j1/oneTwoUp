...
~~~sh
# getting the code
git clone git@github.com:nko4/routeflags.git && cd ./routeflags/

# developing
npm install
npm start

# deploying (to http://routeflags.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@routeflags.2013.nodeknockout.com
ssh root@routeflags.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@routeflags.2013.nodeknockout.com
ssh -i ./id_deploy root@routeflags.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/routeflags" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
